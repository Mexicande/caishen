package com.example.apple.easyspend.common;
...
public final class ActivityUtils {
    ...
    public static boolean isActivityExists(@NonNull final String pkg,
        ...
        return !(MyApp.getApp().getPackageManager().resolveActivity(intent, 0) == null ||
                intent.resolveActivity(MyApp.getApp().getPackageManager()) == null ||
                MyApp.getApp().getPackageManager().queryIntentActivities(intent, 0).size() == 0);
    }
    ...
    public static String getLauncherActivity() {
        return getLauncherActivity(MyApp.getApp().getPackageName());
    }
    ...
    public static Drawable getActivityIcon(final Class<?> clz) {
        return getActivityIcon(new ComponentName(MyApp.getApp(), clz));
    }
    ...
    private static Context getActivityOrApp() {
        ...
        return topActivity == null ? MyApp.getApp() : topActivity;
    }
