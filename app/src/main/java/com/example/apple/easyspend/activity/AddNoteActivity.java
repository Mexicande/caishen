...
public class AddNoteActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        user = com.example.apple.easyspend.activity.MyApp.user;
        ...
        if (bundle!=null){
            ...
            add_date = com.example.apple.easyspend.activity.MyApp.today_date;//日期
        }
    ...
    private void initView(){
        ...
        if (isFromFragment){
            ...
            toolbar_name.setText("添加便签");
            date.setText(com.example.apple.easyspend.activity.MyApp.today_date);
        }
