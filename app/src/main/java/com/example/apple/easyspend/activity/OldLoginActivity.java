...
import com.example.apple.easyspend.net.MyVolleySingle;
import com.example.apple.easyspend.net.UrlManager;
import com.example.apple.easyspend.net.VolleyStringPost;
    ...
    public void onClick(View v) {
        ...
        switch (id){
            case R.id.login_bt:
                ...
                break;
            case R.id.reg_user:
                Intent intent = new Intent(OldLoginActivity.this,RegistActivity.class);
...
//                        }
                        ...
                        if (user==null){
                            ...
                            try{
                                ...
                                MyApp.user = (User) qb1.orderDesc(UserDao.Properties.U_id).list().get(0);
...
//            }
    ...
    private void toast(String str){
        Toast.makeText(OldLoginActivity.this, str, Toast.LENGTH_SHORT).show();
    }
